// Single-path icons in the house style (1.8 stroke, round caps). Kept inline
// rather than taking an icon package — the whole set is smaller than the import.

const PATHS: Record<string, string> = {
  grid: "M3 3h7v7H3zM14 3h7v7h-7zM14 14h7v7h-7zM3 14h7v7H3z",
  users: "M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75",
  calendar: "M3 4h18v18H3zM3 9h18M8 2v4M16 2v4",
  mail: "M2 4h20v16H2zM2 5l10 7L22 5",
  flow: "M6 3v6M6 15v6M18 3v6M18 15v6M6 9a3 3 0 0 0 3 3h6a3 3 0 0 1 3 3",
  book: "M4 19.5A2.5 2.5 0 0 1 6.5 17H20M4 19.5V5a2 2 0 0 1 2-2h14v14M4 19.5A2.5 2.5 0 0 0 6.5 22H20",
  ...
  wrench: "M14.7 6.3a4 4 0 0 0 5 5l-9.4 9.4a2.8 2.8 0 0 1-4-4l9.4-9.4a4 4 0 0 0-1 4z",
